apiKey = "2d62a5fc9712784f4836c711e52d352f";
apiUrl = "https://api.themoviedb.org/3/"
let resultat = document.getElementById("resultat");
let scroll2 = document.getElementById("scroll2");
let scroll3 = document.getElementById("scroll3");

function lienFetch(a,b){
  for (let i = 1; i <= 10; i++) {
      fetch(apiUrl +a+"/top_rated?api_key="+ apiKey +"&language=en-US&page=" + i +"")
        .then((response) => {
        ...
        .then((data) => {
          data.results.forEach((element) => {
            ...
            aMovie.href = "detail.php?id=" + element.id + "&type=" + a;
            ...
            aMovie.append(imgMovie);
            divMovie.append(aMovie);
            b.append(divMovie);
          });
        })
    }
...
lienFetch("movie",scroll2)
lienFetch("tv",scroll3)

const imgUrl = "https://image.tmdb.org/t/p/original";
let container = document.getElementById("container");
let favorisDiv = document.getElementById("favorisDiv");
let favorisBtn = document.getElementById("favorisBtn");
let iconFAV = '<i class="fa-regular fa-heart" style="color: #8a0000;"></i>';
let iconNotFav = '<i class="fa-solid fa-heart" style="color: #8a0000;"></i>'
